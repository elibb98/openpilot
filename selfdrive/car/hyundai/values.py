...
CAR_INFO: Dict[str, Optional[Union[HyundaiCarInfo, List[HyundaiCarInfo]]]] = {
  ...
  CAR.KIA_K8_1ST_GEN: HyundaiCarInfo("Kia K8 2023", "All", car_parts=CarParts.common([CarHarness.hyundai_k])),
...
CANFD_CAR = {CAR.KIA_EV6, CAR.IONIQ_5, CAR.IONIQ_6, CAR.TUCSON_4TH_GEN, CAR.TUCSON_HYBRID_4TH_GEN, CAR.KIA_SPORTAGE_HYBRID_5TH_GEN,
             ...
             CAR.STARIA_4TH_GEN, CAR.KIA_K8_1ST_GEN}
...
DBC = {
  ...
  CAR.KIA_K8_1ST_GEN: dbc_dict('hyundai_canfd', None),
}
